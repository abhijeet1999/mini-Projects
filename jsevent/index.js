...
var image = productList[0].preview;
div1.id = "div1"
div2.id = "div2";
div23.id = "div23";
h11.id = "h11";
...
h31.innerHTML = "Price: Rs ";
h32.innerHTML = "Description";
h33.innerHTML = "Product Preview";
p1.innerHTML = productList[0].description;
span1.innerHTML = productList[0].price;
h11.innerHTML = productList[0].name;
h41.innerHTML = productList[0].brand;
...
div2.appendChild(p1);
div23.appendChild(h41);
for (var i = 0; i < productList[0].photos.length; i++) {
    var img = document.createElement("img");
    img.className = "img"
    img.setAttribute ("id" ,"a"+ (i + 1));
    img.src = productList[0].photos[i];
    console.log(productList[0].photos[i]);
    div24.appendChild(img);
    
    //console.log(productList[0].photos[i])
}
console.log(div24);
var photo0 = document.getElementById("a1");
console.log(photo0);
var photo1 = document.getElementById("a2");
var photo2 = document.getElementById("a3");
var photo3 = document.getElementById("a4");

var photo4 = document.getElementById("a5");
imgprev.src = productList[0].photos[0];
...
function changeImage() {
    ...
    photo0.addEventListener("click", function () {
        imgprev.src = productList[0].photos[0];
        photo0.style.border = " 2px solid #009688";
        photo1.style.border = " 2px solid #ffff";
        photo2.style.border = " 2px solid #ffff";
        photo3.style.border = " 2px solid #ffff";
        photo4.style.border = " 2px solid #ffff";
    });

    // Photo 1
    photo1.addEventListener("click", function () {
        imgprev.src = productList[0].photos[1];
        photo1.style.border = " 2px solid #009688";
        photo0.style.border = " 2px solid #ffff";
        photo2.style.border = " 2px solid #ffff";
        photo3.style.border = " 2px solid #ffff";
        photo4.style.border = " 2px solid #ffff";
    ...
    photo2.addEventListener("click", function () {
        imgprev.src = productList[0].photos[2];
        photo2.style.border = " 2px solid #009688";
        photo0.style.border = " 2px solid #ffff";
        photo1.style.border = " 2px solid #ffff";
        photo3.style.border = " 2px solid #ffff";
        photo4.style.border = " 2px solid #ffff";
    ...
    photo3.addEventListener("click", function () {
        imgprev.src = productList[0].photos[3];
        photo3.style.border = " 2px solid #009688";
        photo1.style.border = " 2px solid #ffff";
        photo2.style.border = " 2px solid #ffff";
        photo0.style.border = " 2px solid #ffff";
        photo4.style.border = " 2px solid #ffff";
    ...
    photo4.addEventListener("click", function () {
        imgprev.src = productList[0].photos[4];
        photo4.style.border = " 2px solid #009688";
        photo1.style.border = " 2px solid #ffff";
        photo2.style.border = " 2px solid #ffff";
        photo3.style.border = " 2px solid #ffff";
        photo0.style.border = " 2px solid #ffff";
...
var h11 = document.createElement("h1");
h11.innerText = "Clothing for Men and Women";
h11.className = "h11";
section1.appendChild(h11);
var section2 = document.getElementById("section2");
var h21 = document.createElement("h1");
h21.innerText = "Accessories for Men and Women";
h21.className = "h11";
section2.appendChild(h21);
var outerdiv = document.createElement("div");
outerdiv.className = "outer"
var outerdiv2 = document.createElement("div");
outerdiv2.className = "outer"

for (let i = 0; i < productList.length; i++) {
   // console.log(productList[i].isAccessory);
    if (!productList[i].isAccessory) {
        ...
        newImgElement.src = productList[i].preview;
        ...
        newImgElement1.src = productList[i].preview;
        var h33 = document.createElement("h3");
        h33.className = "h33";
        h33.innerHTML = productList[i].name;
        var h44 = document.createElement("h4");
        h44.innerHTML = productList[i].brand;
        h44.className = "h44";
        var h55 = document.createElement("h5");
        h55.innerHTML = productList[i].price;
        h55.className = "h55";
        var detail2 = document.createElement("div");
        detail2.className = "detail"
        detail2.appendChild(h33);
        detail2.appendChild(h44);
        detail2.appendChild(h55);
        div1.appendChild(newImgElement1);
        div1.appendChild(detail2);
        
        outerdiv2.appendChild(div1);
        section2.appendChild(outerdiv2);
    }
